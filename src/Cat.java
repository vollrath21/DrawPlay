...
public class Cat {
	...
	private static final int EYE_WIDTH = 100; // Made the eyes less realistic
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		int y=catY;
		// Draw the head
		g2.setColor(Color.gray); //Gray looks more like a cat
		...
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		// Draw the mouth
		g2.setColor(Color.red); // Red is a much better color than pink
		x = catX + MOUTH_X;
		y = catY + MOUTH_Y;
